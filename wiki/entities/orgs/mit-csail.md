...
diffusion-forcing as the per-token-noise paradigm — is essentially the
substrate for the modern real-time-chunking line (RTC / Training-Time
RTC / πR²). Worth tracking as the lineage extends.